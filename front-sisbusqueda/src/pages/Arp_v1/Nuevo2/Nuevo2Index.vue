  ...
  <q-page>
    ...
    <div class="row">
      <SelectInput class="col-4 q-px-xs" label="Notarios" dense clearable
        v-model="nombreNotario" :options="GenerateListService" :GenerateList="{ column: 'notario', table: 'nuevo2' }" />
      <SelectInput class="col-4 q-px-xs" label="Lugar" dense clearable
        v-model="nombreLugar" :options="GenerateListService" :GenerateList="{ column: 'lugar', table: 'nuevo2' }" />
      <SelectInput class="col-4 q-px-xs" label="Subserie" dense clearable
        v-model="nombreSubserie" :options="GenerateListService" :GenerateList="{ column: 'subserie', table: 'nuevo2' }" />
    </div>
    <q-table
