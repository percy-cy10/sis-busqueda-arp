...
//   RangoAnios: { default: [notarioAñoInicio.value,, notarioAñoFinal.value] },
...
const props = defineProps({
  ...
  RangoFechas: {
    type: Array,
    default: () => ['01/01/1801', convertDate(new Date(),'dd/MM/yyyy')]
  },
...
const anios = computed(() => {
  ...
  // }
  for (let year = inicio.value; year <= fin.value; year++) { // Usar .value
    aniosArray.push(year);
  }
