...
class SolicitudController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Solicitud::create([
            ...
            'materia_proceso' => $request->materia_proceso,
            ...
            'nombre_fallecido' => $request->nombre_fallecido,
            'nombre_nacido' => $request->nombre_nacido,
            'nombre_esposo' => $request->nombre_esposo,
            'nombre_esposa' => $request->nombre_esposa,
            'contrato_privado' => $request->contrato_privado,
            'otorgante_enace' => $request->otorgante_enace,
            'favorecido_enace' => $request->favorecido_enace,
            'institucion_enace' => $request->institucion_enace,
            'causante_impuesto' => $request->causante_impuesto,
            'direccion_impuesto' => $request->direccion_impuesto,
            'proceso_de' => $request->proceso_de,
            'en_contra_de' => $request->en_contra_de,
            'causante_proceso' => $request->causante_proceso,
            'notario_proceso' => $request->notario_proceso,
            'tipo_expediente_mp' => $request->tipo_expediente_mp,
            'caso_mp' => $request->caso_mp,
            'area_mp' => $request->area_mp,
            'materia_mp' => $request->materia_mp,
            'agraviado_mp' => $request->agraviado_mp,
            'imputado_mp' => $request->imputado_mp,
            'fiscalia_mp' => $request->fiscalia_mp,
            'numero_caso_mp' => $request->numero_caso_mp,
            'numero_paquete_mp' => $request->numero_paquete_mp,
            'sescritura' => $request->sescritura,
            'sprotocolo' => $request->sprotocolo,
            'sfolio' => $request->sfolio,
        ]);
